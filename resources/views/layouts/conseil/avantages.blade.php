<div class='row d-none d-md-flex' id="avantages">
    ...
    <div class="col-md-7 col-12 offset-md-2 muli-extra-bold my-5" id="list">
        <div class="row ">
            ...
            <div class="col-md-10 content border-top py-4 px-0">D’un accompagnement personnalisé pour atteindre votre objectif de certification</div>
        ...
        <div class="row ">
            ...
            <div class="col-md-10 content border-top py-4 px-0">D’outils pratiques pour la mise en œuvre du système de management de la qualité</div>
            <div class="col-md-1 icon py-4 text-center">✓</div>
        </div>
        <div class="row ">
        ...
        <div class="row ">
            ...
            <div class="col-md-10 content border-top border-bottom py-4 px-0">Vous pourrez échanger avec d’autres entreprises qui ont les mêmes problématiques que vous</div>
            <div class="col-md-1 icon py-4 text-center">✓</div>
        </div>
    </div>
</div>