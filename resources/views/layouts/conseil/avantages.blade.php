        ...
        <div class="row ">
            ...
            <div class="col-md-10 content border-top py-4 px-0">
                @if($conseil->avantage1!="")
                    {{$conseil->avantage1}}
                @else
                    D’un accompagnement personnalisé pour atteindre votre objectif de certification</div>
                @endif
        ...
        <div class="row">
            ...
            <div class="col-md-10 content border-top py-4 px-0">
                @if($conseil->avantage2!="")
                    {{$conseil->avantage2}}
                @else
                    De la formation et d’échange de bonnes pratiques en conseil {{$conseil->certification}}</div>
                @endif
            <div class="col-md-1 icon py-4 text-center">✓</div>
        </div>
        <div class="row ">
            ...
            <div class="col-md-10 content border-top py-4 px-0">
                @if($conseil->avantage3!="")
                    {{$conseil->avantage3}}
                @else
                    D’outils pratiques pour la mise en œuvre du système de management de la qualité</div>
                @endif
            <div class="col-md-1 icon py-4 text-center">✓</div>
        </div>
        <div class="row ">
            ...
            <div class="col-md-10 content border-top py-4 px-0">
                @if($conseil->avantage4!="")
                    {{$conseil->avantage4}}
                @else
                    D’un suivi tout au long de votre démarche et après l’obtention de la certification {{$conseil->certification}}</div>
                @endif
            <div class="col-md-1 icon py-4 text-center">✓</div>
        </div>
        <div class="row ">
            ...
            <div class="col-md-10 content border-top border-bottom py-4 px-0">
                @if($conseil->avantage5!="")
                    {{$conseil->avantage5}}
                @else
                    Vous pourrez échanger avec d’autres entreprises qui ont les mêmes problématiques que vous</div>
                @endif
            <div class="col-md-1 icon py-4 text-center">✓</div>
        </div>
    </div>
